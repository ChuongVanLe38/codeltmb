...
class _FormBasicDemoSate extends State<FormBasicDemo> {
  ...
  List<String> _cities = ['Hà Nội', 'Hồ Chí Minh', 'Đà Nẵng', 'Cần Thơ']; // Các thành phố
  String? _gender;
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                value: _selectedCity, // Biến này phải được định nghĩa ở đâu đó trong class
                items: _cities.map((city) {
                  return DropdownMenuItem<String>(
                    child: Text(city),
                    value: city,
                  );
                }).toList(), // Chuyển map thành list tại đây
                onChanged: (value) {
                  setState(() {
                    _selectedCity = value; // Cập nhật giá trị _selectedCity khi người dùng chọn
                  });
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              CheckboxListTile(
                title: Text("Đồng ý với các điều khoản của công ty ABC"),
                value: _isAgreed,
                onChanged: (value){
                  setState(() {
                    _isAgreed = value!;
